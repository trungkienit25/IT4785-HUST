...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        when (lemonadeState) {
            ...
            "squeeze" -> {
                // Ép chanh cho đến khi không còn nước
                squeezeCount++
                lemonSize--
                if (lemonSize == 0) {
                    lemonadeState = "drink"
        ...
        setViewElements()  // Cập nhật giao diện sau khi thay đổi trạng thái
    }
    ...
    private fun setViewElements() {
        ...
        // Cập nhật nội dung text dựa vào trạng thái hiện tại
        val actionText = when (lemonadeState) {
        ...
        // Cập nhật ảnh của chanh dựa trên trạng thái hiện tại
        val lemonImageRes = when (lemonadeState) {
        ...
        lemonImage!!.setImageResource(lemonImageRes)
    }
